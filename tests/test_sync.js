...
gulp.task('task0', function() {
  setTimeout(function() { console.log('task0 end.'); }, 2000);
});
...
gulp.task('task2.1', function() {
  setTimeout(function() { console.log('task2.1 end.'); }, 1000);
});
...
gulp.task('task3.1', function() {
  setTimeout(function() { console.log('task3.1 end.'); }, 3000);
});

gulp.task('task3.2', function() {
  setTimeout(function() { console.log('task3.2 end.'); }, 1000);
});
